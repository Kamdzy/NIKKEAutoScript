...
export const staticLabels: Record<string, Record<string, string>> = {
  ...
  // Kamdzy - en-US/ja-JP staticLabels bulk-added post upstream merge (icon
  // refactor #258 + instance-icon feature #259 introduced ~140 new zh-CN t()
  // keys). ja-JP entries are best-effort so the en-US client is fully covered
  // and Japanese users see reasonable copy rather than the raw zh-CN fallback.
  'Serial 为 auto 时无法使用互动模式': { 'en-US': 'Interactive mode is unavailable when Serial is set to auto', 'ja-JP': 'Serial が auto の場合、対話モードは使用できません' },
  '不足1分钟': { 'en-US': 'Less than 1 minute', 'ja-JP': '1分未満' },
  '为': { 'en-US': 'for', 'ja-JP': 'に' },
  '仅 adb 可用': { 'en-US': 'Only ADB is available', 'ja-JP': 'ADB のみ利用可能' },
  '分钟': { 'en-US': 'min', 'ja-JP': '分' },
  '刷新频率': { 'en-US': 'Refresh rate', 'ja-JP': '更新頻度' },
  '剧情活动': { 'en-US': 'Story event', 'ja-JP': 'ストーリーイベント' },
  '剩余': { 'en-US': 'Remaining', 'ja-JP': '残り' },
  '即将结束': { 'en-US': 'Ending soon', 'ja-JP': 'まもなく終了' },
  '天': { 'en-US': 'day', 'ja-JP': '日' },
  '头像': { 'en-US': 'Avatar', 'ja-JP': 'アイコン' },
  '实时': { 'en-US': 'Live', 'ja-JP': 'リアルタイム' },
  '导入截图记录': { 'en-US': 'Import screenshots', 'ja-JP': 'スクリーンショットを取り込む' },
  '小时': { 'en-US': 'hour', 'ja-JP': '時' },
  '开始': { 'en-US': 'Start', 'ja-JP': '開始' },
  '招募': { 'en-US': 'Recruit', 'ja-JP': '募集' },
  '持有': { 'en-US': 'Owned', 'ja-JP': '所持' },
  '控制': { 'en-US': 'Control', 'ja-JP': '操作' },
  '操作栏': { 'en-US': 'Action bar', 'ja-JP': '操作バー' },
  '文件选择失败，请直接输入路径。': { 'en-US': 'File picker failed, please enter the path directly.', 'ja-JP': 'ファイル選択に失敗しました、パスを直接入力してください。' },
  '时装': { 'en-US': 'Costumes', 'ja-JP': 'コスチューム' },
  '暂无仓库物品记录。': { 'en-US': 'No warehouse item records yet.', 'ja-JP': '倉庫の記録はまだありません。' },
  '暂无拦截战掉落记录。': { 'en-US': 'No Interception drop records yet.', 'ja-JP': '迎撃戦のドロップ記録はまだありません。' },
  '暂无画面': { 'en-US': 'No preview', 'ja-JP': 'プレビューなし' },
  '暂无进行中的活动': { 'en-US': 'No events in progress', 'ja-JP': '進行中のイベントはありません' },
  '更改头像': { 'en-US': 'Change avatar', 'ja-JP': 'アイコンを変更' },
  '更新于': { 'en-US': 'Updated', 'ja-JP': '更新日時' },
  '最后6小时': { 'en-US': 'Last 6 hours', 'ja-JP': '直近6時間' },
  '未配置 ws-scrcpy 地址': { 'en-US': 'ws-scrcpy address not configured', 'ja-JP': 'ws-scrcpy アドレスが未設定' },
  '正在读取仓库记录…': { 'en-US': 'Loading warehouse records...', 'ja-JP': '倉庫の記録を読み込み中...' },
  '正在选择…': { 'en-US': 'Choosing...', 'ja-JP': '選択中...' },
  '活动数据加载失败': { 'en-US': 'Failed to load event data', 'ja-JP': 'イベントデータの読み込みに失敗' },
  '活动日历': { 'en-US': 'Event calendar', 'ja-JP': 'イベントカレンダー' },
  '点击更改头像': { 'en-US': 'Click to change avatar', 'ja-JP': 'クリックでアイコンを変更' },
  '物品': { 'en-US': 'Items', 'ja-JP': 'アイテム' },
  '画面预览': { 'en-US': 'Screen preview', 'ja-JP': '画面プレビュー' },
  '竞技场': { 'en-US': 'Arena', 'ja-JP': 'アリーナ' },
  '结束': { 'en-US': 'End', 'ja-JP': '終了' },
  '维护时间': { 'en-US': 'Maintenance window', 'ja-JP': 'メンテ時間' },
  '维护进行中': { 'en-US': 'Maintenance in progress', 'ja-JP': 'メンテ中' },
  '维护通知': { 'en-US': 'Maintenance notice', 'ja-JP': 'メンテ通知' },
  '请输入截图目录。': { 'en-US': 'Please enter the screenshot directory.', 'ja-JP': 'スクリーンショットのディレクトリを入力してください。' },
  '超频': { 'en-US': 'Overclock', 'ja-JP': 'オーバークロック' },
  '距离Buff重置': { 'en-US': 'Until buff reset', 'ja-JP': 'バフリセットまで' },
  '距维护开始': { 'en-US': 'Until maintenance', 'ja-JP': 'メンテ開始まで' },
  '转盘': { 'en-US': 'Wheel', 'ja-JP': 'ホイール' },
  '近 12 周': { 'en-US': 'Last 12 weeks', 'ja-JP': '直近12週' },
  '近 12 月': { 'en-US': 'Last 12 months', 'ja-JP': '直近12ヶ月' },
  '近 30 天': { 'en-US': 'Last 30 days', 'ja-JP': '直近30日' },
  '退出控制': { 'en-US': 'Exit control', 'ja-JP': '操作終了' },
  '选择头像': { 'en-US': 'choose an avatar', 'ja-JP': 'アイコンを選択' },
  '预计结束': { 'en-US': 'Estimated end', 'ja-JP': '終了予定' },
}
