...
// Kamdzy - expose UI language to Field* components that render user-facing text
                  ...
                  <div class="field-control">
                    ...
                    <template v-else-if="field.path_picker">
                      <div class="path-field">
                        ...
                        <FieldPathPicker :value="field.value" :picker="field.path_picker" :disabled="field.display !== 'show'" :language="systemStatus.language" @picked="pickedPath(field, $event)" @error="toast.error = $event"/>
                      </div>
                    </template>
                    ...
                    <FieldInterception v-else-if="field.widget === 'interception_stone_import'" :widget="field.widget" :busy="Boolean(importBusy[field.key])" :language="systemStatus.language" @import="importInterception(field, $event)" @error="toast.error = $event"/>
